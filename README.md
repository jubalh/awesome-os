...
* [Equinox OS](https://github.com/amnottdevv/Equinox-os) - A 32-bit x86 hobby operating system written from scratch in C++17 featuring a self-hosting C compiler, preemptive multitasking, demand paging, FAT32 read/write, a TCP/IP stack with HTTPS, and a built-in LVGL desktop.
