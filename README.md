...
* [CollapseOS](https://github.com/rdacomp/CollapseOS) - A open-source, Forth-based post-apocalyptic operating system designed to run on salvaged, primitive microcontrollers.
